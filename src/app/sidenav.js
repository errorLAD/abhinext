...
<ul>
  <li>
      ...
      <li>
      <a href="" className=" text-xs font-medium me-2 px-2.5 py-1.5 rounded border border-gray-200">Job Type: <span class="text-orange-500 ">  Full-Time</span></a>
      </li>
      ...
      <div className="flex ">
                    ...
                    <div className="flex-1 min-w-0 ms-4">
                        ...
                        <h6 className="text-xs text-gray-500 truncate dark:text-gray-200">
                         Get All Feature 
                        {/* Success */}
